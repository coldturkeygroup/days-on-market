=== Platform Days on Market Funnel ===
...
Installing "Days on Market" can be done either by searching for "Days on Market" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
